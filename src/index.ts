type Tag = Element | any

const course_number: Tag = document.querySelector("#course-number");
const calc: Tag = document.querySelector("#calculator");
const credit: Tag = document.querySelector(".course-credit");
const grade: Tag = document.querySelector(".grades");

course_number.addEventListener("submit", function(e: any){
    const num: Tag = document.querySelector("#num");
    const numValue: Number = num.value
    const gpsection: Tag = document.querySelector(".gp-section")
    const calculator: Tag = document.querySelector("#calculator")
    if (numValue === undefined){
        ...
        gpsection.style.height = "auto";
        calculator.style.marginBottom = "5rem";
        for (let i = 0; i < Number(numValue); i++){
...
let all_credit: any = [];
let all_grade: any = [];
let gradeXcredit: Number[] = [];

calc.addEventListener("submit", function(e: any){
    ...
    grade_sum = gradeXcredit.reduce((a:any,b:any) => a+b, 0);
    credit_sum = all_credit.reduce((a:any,b:any) => a+b,0);
    let gp: Tag = document.querySelector(".gp-grade");
